...
public class Lib {
    ...
    public String kernelGenPassword(int sizePassword, boolean useSings, boolean useBigLetters,boolean useSmallLetters, boolean useNumbers) {
    	/*if (sizePassword == 0 && useSings == false && useBigLetters == false && useSmallLetters == false && useNumbers == false) {
    		return null;
    	}*/
        ...
        //то оно является пригодным и используется для вытаскивания символов из переменной Symbols. (Symbols.CharAt(randomnum)).
